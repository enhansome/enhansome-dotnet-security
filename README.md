...
*List inspired by the [awesome](https://github.com/sindresorhus/awesome) ⭐ 502,318 | 🐛 105 | 📅 2026-09-02 list thing.*
...
* [Snyk](https://github.com/snyk/snyk) ⭐ 5,654 | 🐛 134 | 🌐 TypeScript | 📅 2026-09-02 - CLI and build-time tool to find & fix known vulnerabilities in open-source dependencies.
...
* [The Most Vulnerable .NET App](https://github.com/AlexGoOn/the-most-vulnerable-dotnet-app) ⭐ 517 | 🐛 0 | 🌐 HTML | 📅 2026-03-06 - A GitHub repository featuring an application with over 50 interactive security vulnerabilities.
