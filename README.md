...
*List inspired by the [awesome](https://github.com/sindresorhus/awesome) ⭐ 501,978 | 🐛 105 | 📅 2026-08-21 list thing.*
...
* [JWT .NET](https://github.com/jwt-dotnet/jwt) ⭐ 2,192 | 🐛 10 | 🌐 C# | 📅 2026-08-12 - Jwt.Net, a JWT (JSON Web Token) implementation for .NET.
...
* [Snyk](https://github.com/snyk/snyk) ⭐ 5,654 | 🐛 133 | 🌐 TypeScript | 📅 2026-09-01 - CLI and build-time tool to find & fix known vulnerabilities in open-source dependencies.
...
* [The Most Vulnerable .NET App](https://github.com/AlexGoOn/the-most-vulnerable-dotnet-app) ⭐ 510 | 🐛 0 | 🌐 HTML | 📅 2026-03-06 - A GitHub repository featuring an application with over 50 interactive security vulnerabilities.
