...
*List inspired by the [awesome](https://github.com/sindresorhus/awesome) ⭐ 495,258 | 🐛 100 | 📅 2026-06-30 list thing.*
...
* [HtmlSanitizer](https://github.com/mganss/HtmlSanitizer) ⭐ 1,707 | 🐛 20 | 🌐 C# | 📅 2026-08-13 - Cleans HTML to avoid XSS attacks.
...
* [Snyk](https://github.com/snyk/snyk) ⭐ 5,636 | 🐛 132 | 🌐 TypeScript | 📅 2026-08-13 - CLI and build-time tool to find & fix known vulnerabilities in open-source dependencies.
