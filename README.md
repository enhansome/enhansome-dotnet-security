...
*List inspired by the [awesome](https://github.com/sindresorhus/awesome) ⭐ 504,481 | 🐛 106 | 📅 2026-09-02 list thing.*
...
* [AspNetCoreRateLimit](https://github.com/stefanprodan/AspNetCoreRateLimit) ⭐ 3,168 | 🐛 185 | 🌐 C# | 📅 2024-07-26 - Package that will let you set rate limits for your .NET Core Api.
* [JWT .NET](https://github.com/jwt-dotnet/jwt) ⭐ 2,190 | 🐛 10 | 🌐 C# | 📅 2026-09-09 - Jwt.Net, a JWT (JSON Web Token) implementation for .NET.
* [HtmlSanitizer](https://github.com/mganss/HtmlSanitizer) ⭐ 1,708 | 🐛 19 | 🌐 C# | 📅 2026-09-09 - Cleans HTML to avoid XSS attacks.
...
* [DevSkim](https://github.com/Microsoft/DevSkim) ⭐ 1,005 | 🐛 76 | 🌐 C# | 📅 2026-09-03 - DevSkim is a set of IDE plugins and rules that provide security "linting" capabilities.
...
* [Snyk](https://github.com/snyk/snyk) ⭐ 5,657 | 🐛 136 | 🌐 TypeScript | 📅 2026-09-09 - CLI and build-time tool to find & fix known vulnerabilities in open-source dependencies.
* [.NET Security Announcements](https://github.com/dotnet/announcements/issues?q=is%3Aopen+is%3Aissue+label%3ASecurity) ⭐ 1,376 | 🐛 406 | 📅 2022-06-29 - Watch this repo to receive security announcements in .NET Core
...
* [The Most Vulnerable .NET App](https://github.com/AlexGoOn/the-most-vulnerable-dotnet-app) ⭐ 525 | 🐛 0 | 🌐 HTML | 📅 2026-03-06 - A GitHub repository featuring an application with over 50 interactive security vulnerabilities.
