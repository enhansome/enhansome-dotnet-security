...
*List inspired by the [awesome](https://github.com/sindresorhus/awesome) ⭐ 502,639 | 🐛 105 | 📅 2026-09-02 list thing.*
...
* [JWT .NET](https://github.com/jwt-dotnet/jwt) ⭐ 2,192 | 🐛 11 | 🌐 C# | 📅 2026-09-03 - Jwt.Net, a JWT (JSON Web Token) implementation for .NET.
* [HtmlSanitizer](https://github.com/mganss/HtmlSanitizer) ⭐ 1,707 | 🐛 15 | 🌐 C# | 📅 2026-08-28 - Cleans HTML to avoid XSS attacks.
...
* [DevSkim](https://github.com/Microsoft/DevSkim) ⭐ 1,004 | 🐛 76 | 🌐 C# | 📅 2026-09-03 - DevSkim is a set of IDE plugins and rules that provide security "linting" capabilities.
...
* [Snyk](https://github.com/snyk/snyk) ⭐ 5,654 | 🐛 135 | 🌐 TypeScript | 📅 2026-09-03 - CLI and build-time tool to find & fix known vulnerabilities in open-source dependencies.
...
* [The Most Vulnerable .NET App](https://github.com/AlexGoOn/the-most-vulnerable-dotnet-app) ⭐ 519 | 🐛 0 | 🌐 HTML | 📅 2026-03-06 - A GitHub repository featuring an application with over 50 interactive security vulnerabilities.
