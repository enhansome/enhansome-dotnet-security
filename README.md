...
*List inspired by the [awesome](https://github.com/sindresorhus/awesome) ⭐ 501,683 | 🐛 105 | 📅 2026-08-21 list thing.*
...
* [AspNetCoreRateLimit](https://github.com/stefanprodan/AspNetCoreRateLimit) ⭐ 3,169 | 🐛 185 | 🌐 C# | 📅 2024-07-26 - Package that will let you set rate limits for your .NET Core Api.
...
* [Snyk](https://github.com/snyk/snyk) ⭐ 5,652 | 🐛 135 | 🌐 TypeScript | 📅 2026-08-31 - CLI and build-time tool to find & fix known vulnerabilities in open-source dependencies.
