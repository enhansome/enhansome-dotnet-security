...
*List inspired by the [awesome](https://github.com/sindresorhus/awesome) ⭐ 508,153 | 🐛 106 | 📅 2026-09-02 list thing.*
...
* [DevSkim](https://github.com/Microsoft/DevSkim) ⭐ 1,006 | 🐛 80 | 🌐 C# | 📅 2026-09-15 - DevSkim is a set of IDE plugins and rules that provide security "linting" capabilities.
...
* [Snyk](https://github.com/snyk/snyk) ⭐ 5,663 | 🐛 126 | 🌐 TypeScript | 📅 2026-09-20 - CLI and build-time tool to find & fix known vulnerabilities in open-source dependencies.
...
* [The Most Vulnerable .NET App](https://github.com/AlexGoOn/the-most-vulnerable-dotnet-app) ⭐ 526 | 🐛 0 | 🌐 HTML | 📅 2026-03-06 - A GitHub repository featuring an application with over 50 interactive security vulnerabilities.
* [WebGoat.NET](https://github.com/jerryhoff/WebGoat.NET) ⭐ 258 | 🐛 16 | 🌐 C# | 📅 2023-12-16 - OWASP WebGoat.NET
