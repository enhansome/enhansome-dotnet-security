...
*List inspired by the [awesome](https://github.com/sindresorhus/awesome) ⭐ 506,296 | 🐛 106 | 📅 2026-09-02 list thing.*
...
* [HtmlSanitizer](https://github.com/mganss/HtmlSanitizer) ⭐ 1,708 | 🐛 15 | 🌐 C# | 📅 2026-09-14 - Cleans HTML to avoid XSS attacks.
...
* [AspNetSaml](https://github.com/jitbit/AspNetSaml) ⭐ 420 | 🐛 4 | 🌐 C# | 📅 2026-08-20 - SAML client library, allows adding SAML single-sign-on to your ASP.NET app.
...
* [DevSkim](https://github.com/Microsoft/DevSkim) ⭐ 1,005 | 🐛 79 | 🌐 C# | 📅 2026-09-14 - DevSkim is a set of IDE plugins and rules that provide security "linting" capabilities.
...
* [Snyk](https://github.com/snyk/snyk) ⭐ 5,663 | 🐛 135 | 🌐 TypeScript | 📅 2026-09-15 - CLI and build-time tool to find & fix known vulnerabilities in open-source dependencies.
