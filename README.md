...
*List inspired by the [awesome](https://github.com/sindresorhus/awesome) ⭐ 508,558 | 🐛 106 | 📅 2026-09-02 list thing.*
...
* [DevSkim](https://github.com/Microsoft/DevSkim) ⭐ 1,007 | 🐛 80 | 🌐 C# | 📅 2026-09-15 - DevSkim is a set of IDE plugins and rules that provide security "linting" capabilities.
...
* [Snyk](https://github.com/snyk/snyk) ⭐ 5,663 | 🐛 124 | 🌐 TypeScript | 📅 2026-09-21 - CLI and build-time tool to find & fix known vulnerabilities in open-source dependencies.
